...
class HomeSideMenu: UIView {
    ...
    func addButtons() {
        ...
        profileButton.tag = HomeSideMenuButtonType.Profile.rawValue
        ...
        galleryButton.tag = HomeSideMenuButtonType.Gallery.rawValue
        ...
        settingsButton.tag = HomeSideMenuButtonType.Settings.rawValue
        ...
        storeButton.tag = HomeSideMenuButtonType.Store.rawValue
        ...
        hintsButton.tag = HomeSideMenuButtonType.Hints.rawValue
